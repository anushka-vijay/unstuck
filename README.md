...
You dump whatever's swirling, Claude extracts the 2–3 things it heard,
...
- Anthropic SDK (`@anthropic-ai/sdk`) called directly from the browser
...
If `VITE_ANTHROPIC_API_KEY` is missing, the app drops into **demo mode**: task
...
2. **Task chips** — Claude reads the chaos, surfaces 2–3 specific things you mentioned, plus a "something else entirely" escape hatch. Tap one.
